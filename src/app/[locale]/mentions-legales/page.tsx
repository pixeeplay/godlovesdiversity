...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <article className="container-tight py-20 prose prose-invert max-w-3xl">
      ...
      <p>Site édité par le mouvement <em>God Loves Diversity</em>.</p>
      <p>Contact : <a className="text-brand-pink" href="mailto:hello@godlovesdiversity.com">hello@godlovesdiversity.com</a></p>
      <h2>Hébergement</h2>
