...
export const metadata = { title: 'Mes cercles de prière — Mon espace GLD' };
export default function P() {
  return (
    <MePageWrap title="Mes cercles de prière" emoji="🙏">
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 text-zinc-300">
        <p className="text-sm mb-2">Cercles auxquels tu participes (catholique, juif, musulman…).</p>
