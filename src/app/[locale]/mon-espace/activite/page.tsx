...
export const metadata = { title: 'Mon feed perso — Mon espace GLD' };
export default function P() {
  return (
    <MePageWrap title="Mon feed perso" emoji="📊">
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 text-zinc-300">
        <p className="text-sm mb-2">Chronologie de tes actions sur GLD.</p>
