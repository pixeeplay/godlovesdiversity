...
export const metadata = { title: 'Mes ❤ donnés — Mon espace GLD' };
export default function P() {
  return (
    <MePageWrap title="Mes ❤ donnés" emoji="👍">
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 text-zinc-300">
        <p className="text-sm mb-2">Historique des cœurs et soutiens donnés à la communauté.</p>
