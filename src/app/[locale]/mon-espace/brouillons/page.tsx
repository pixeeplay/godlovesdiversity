...
export const metadata = { title: 'Mes brouillons — Mon espace GLD' };
export default function P() {
  return (
    <MePageWrap title="Mes brouillons" emoji="📝">
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 text-zinc-300">
        <p className="text-sm mb-2">Témoignages et posts non encore publiés.</p>
