...
export const metadata = { title: 'Historique IA — Mon espace GLD' };
export default function P() {
  return (
    <MePageWrap title="Historique IA" emoji="🤖">
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 text-zinc-300">
        <p className="text-sm mb-2">Conversations Voice Coach, Verset inclusif, Aide juridique.</p>
