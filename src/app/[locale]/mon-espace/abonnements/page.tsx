...
export const metadata = { title: 'Personnes que je suis — Mon espace GLD' };
export default function P() {
  return (
    <MePageWrap title="Personnes que je suis" emoji="👥">
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 text-zinc-300">
        <p className="text-sm mb-2">Membres de la communauté que tu suis.</p>
