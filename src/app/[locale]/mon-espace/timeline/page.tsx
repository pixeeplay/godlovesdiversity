...
export const metadata = { title: 'Ma timeline GLD — Mon espace GLD' };
export default function P() {
  return (
    <MePageWrap title="Ma timeline GLD" emoji="🕒">
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 text-zinc-300">
        <p className="text-sm mb-2">1ère connexion, 1er post, milestones.</p>
