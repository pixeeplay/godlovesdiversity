...
export const metadata = { title: 'Mes commandes — Mon espace GLD' };
export default function P() {
  return (
    <MePageWrap title="Mes commandes" emoji="📦">
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 text-zinc-300">
        <p className="text-sm mb-2">Historique de tes commandes shop avec tracking.</p>
