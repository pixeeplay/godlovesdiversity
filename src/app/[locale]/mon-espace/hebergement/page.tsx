...
export const metadata = { title: 'Hébergement — Mon espace GLD' };
export default function P() {
  return (
    <MePageWrap title="Hébergement" emoji="🏡">
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 text-zinc-300">
        <p className="text-sm mb-2">Si tu es hôte : tes accueils. Si guest : tes demandes.</p>
