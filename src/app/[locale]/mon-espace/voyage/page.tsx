...
export const metadata = { title: 'Mes pays voyage safe — Mon espace GLD' };
export default function P() {
  return (
    <MePageWrap title="Mes pays voyage safe" emoji="✈️">
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 text-zinc-300">
        <p className="text-sm mb-2">Pays favoris pour pré-remplir la checklist /voyage-safe.</p>
