...
export const metadata = { title: 'Mes photos — Mon espace GLD' };
export default function P() {
  return (
    <MePageWrap title="Mes photos" emoji="📸">
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 text-zinc-300">
        <p className="text-sm mb-2">Toutes les photos que tu as envoyées via /participer ou Telegram.</p>
