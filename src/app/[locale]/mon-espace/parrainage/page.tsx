...
export const metadata = { title: 'Parrainage — Mon espace GLD' };
export default function P() {
  return (
    <MePageWrap title="Parrainage" emoji="🎁">
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 text-zinc-300">
        <p className="text-sm mb-2">Tes invitations envoyées et leur progression.</p>
