...
const STATIC_PAGES_ADMIN = [
  ...
  { title: 'AI Autopilot', href: '/admin/ai-autopilot', tags: 'soul mood modération newsletter quota', category: 'admin' },
  { title: 'Manuels auto IA', href: '/admin/manuals', tags: 'docs user admin video script', category: 'admin' },
  { title: 'Cerveau de GLD (RAG)', href: '/admin/ai/knowledge', tags: 'connaissance', category: 'admin' },
  { title: 'GLD Live avatar', href: '/admin/ai/avatar', tags: 'avatar streaming', category: 'admin' },
