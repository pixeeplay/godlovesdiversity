...
import { listPublicAvatars, listVoices, getCredits } from '@/lib/liveavatar';

export const dynamic = 'force-dynamic';

/**
 * Liste les avatars publics + voix + crédits LiveAvatar pour l'admin.
 */
export async function GET() {
  ...
  try {
    const [avatars, voices, credits] = await Promise.allSettled([
