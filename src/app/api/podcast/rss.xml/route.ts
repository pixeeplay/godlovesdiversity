...
export async function GET() {
  ...
  const items = testimonies
    ...
    <item>
      ...
      <description>${escape(t.transcription?.slice(0, 500) || 'Témoignage du mouvement parislgbt')}</description>
...
<rss version="2.0" xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd" xmlns:content="http://purl.org/rss/1.0/modules/content/">
  <channel>
    <title>parislgbt — Témoignages</title>
    <link>${SITE}</link>
    <language>fr-FR</language>
    <copyright>parislgbt</copyright>
    <itunes:author>parislgbt</itunes:author>
    ...
    <itunes:owner>
      <itunes:name>parislgbt</itunes:name>
    ...
    <itunes:explicit>false</itunes:explicit>
    <description>Voix LGBT+ et croyantes du monde entier — parislgbt podcast.</description>
    ${items}
  </channel>
</rss>`;
