...
const ALL_ITEMS: { href: string; label: string; group: string; alwaysVisible?: boolean; isNew?: boolean }[] = [
  ...
  { href: '/admin/claude-workspace',  label: '🤖 Claude Workspace',           group: 'Nouveau', isNew: true },
  ...
  { href: '/admin/secrets',           label: '🔑 Secrets manager',           group: 'Nouveau', isNew: true },
  { href: '/admin/tasks',             label: '✅ Tasks board',                group: 'Nouveau', isNew: true },
  { href: '/admin/leads',             label: '🎯 Leads CRM',                  group: 'Nouveau', isNew: true },
  { href: '/admin/page-builder',      label: '🎨 Page Builder',               group: 'Nouveau', isNew: true },
